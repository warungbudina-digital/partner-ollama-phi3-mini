...
Target setup ini mengikuti pola repo `partner-AI`, tetapi sudah disesuaikan untuk repo **partner-ollama-phi3-mini**.

- phi3:mini berjalan di VPS terpisah.
...
OpenClaw (server utama) -> `https://llm-bridge-phi3.example.com/v1/chat/completions` -> Cloudflare Tunnel -> FastAPI bridge -> Ollama (`phi3:mini`)
...
- **Public hostname**: misal `llm-bridge-phi3.example.com`
